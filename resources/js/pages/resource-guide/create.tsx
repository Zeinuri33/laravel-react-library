...
export default function CreateResourceGuide() {

    const { prodis } = usePage().props as unknown as Props
...
return
        ...
        router.post(
            ...
            },
            {
                ...
                onSuccess: () => {
                    toast(
                        "Alhamdulillah, resource guide berhasil disimpan",
                        {
                            description: getNow(),
                        }
                    )
    ...
    return (
        <>
            <Head title="Tambah Resource Guide" />
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="flex justify-between">
                    ...
                    <Heading
                        title="Tambah Resource Guide"
                        description="Buat resource guide untuk program studi menggunakan editor modern."
                    />

                    <Link href="/resource-guide">
